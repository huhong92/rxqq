...
$lang['send_login_reward_error']    = '发送电视用户手机端登录奖励失败';
$lang['login_reward_his_error']     = '记录发送电视用户手机端登录奖励失败';
...
$lang['decompose_config_empty_err']         = '分解配置文件为空';
...
$lang['exchange_player_down_err']   = '首次天梯赛替换阵容,球员下场失败';
$lang['exchange_player_up_err']     = '首次天梯赛替换阵容,球员上场失败';
$lang['exchange_structure_err']     = '初始化同步天梯赛阵型失败';
$lang['exchange_position_err']      = '初始化同步球员站位失败';
