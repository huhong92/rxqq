...
class Statics_model extends MY_Model {
     ...
     * @return type
     */
    public function insert_batch($fields, $table) {
        return parent::insert_batch($fields, $table);
    }
     ...
     * @return type
     */
    public function update_where_in($where_fields, $where_in, $pairs, $where, $table)
    {
        return parent::update_where_in($where_fields, $where_in, $pairs, $where, $table);
    }
}
